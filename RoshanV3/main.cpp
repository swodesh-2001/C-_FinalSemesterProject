...
menu menu_points[menu_size] = {menu("square"),menu("rectangle"),menu("triangle"),menu("circle"),menu("pen"),menu("eraser")};
...
if(menu_points[i].get_flag()){
                ...
                if(menu_points[i].get_name() == "pen"){
                    ...
                    for (int i=taken_pen;i<100;i++){for (int j=x_po;j<10000;j++){size_of_pen[i][j]=5;}}
...
case 'S':for (int i=0;i<100;i++){for (int j=x_po;j<10000;j++){size_of_pen[0][j]=10;}}break;
case 'B':for (int i=0;i<100;i++){for (int j=x_po;j<10000;j++){pen_red[0][j]=0;pen_green[0][j]=0;pen_blue[0][j]=0;}}break;
case 'R':for (int i=0;i<100;i++){for (int j=x_po;j<10000;j++){pen_red[0][j]=1;pen_green[0][j]=0;pen_blue[0][j]=0;}}break;
case 'W':for (int i=0;i<100;i++){for (int j=x_po;j<10000;j++){pen_red[0][j]=1;pen_green[0][j]=1;pen_blue[0][j]=1;}}break;
case 'A':for (int i=0;i<100;i++){for (int j=x_po;j<10000;j++){size_of_pen[0][j]=5;}}break;
case 'G':for (int i=0;i<100;i++){for (int j=x_po;j<10000;j++){pen_red[0][j]=0;pen_green[0][j]=1;pen_blue[0][j]=0;}}break;
case 'P':for (int i=0;i<100;i++){for (int j=x_po;j<10000;j++){pen_red[0][j]=0.9;pen_green[0][j]=0.2;pen_blue[0][j]=0.9;}}break;
