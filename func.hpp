...
void create_circle(int x , int y , float radius, float r , float g , float b,int line_width = 5){
for(float i=0 ; i<360 ; i+=0.3){
        create_square(x + radius * cos(i * PI/180),y + radius * sin(i * PI/180),line_width,line_width,r,g,b);
